  		  ...
  		  else if (y > 0 && x > 0 && x < width-1 && y < height -1)
  		  {
  		    ...
  		    PixelSetIteratorRow(iterator_center,y);
  		  	...
  		  	pixels_up = PixelGetCurrentIteratorRow(iterator_up, &width_iterator);
    		 	...
    		 	(PixelGetRed(pixels_down[x]) * 255)+(PixelGetRed(pixels_down[x+1]) * 255))/8); 
    		 	...
    		 	(PixelGetGreen(pixels_down[x]) * 255)+(PixelGetGreen(pixels_down[x+1]) * 255))/8); 
    		 	...
    		 	(PixelGetBlue(pixels_down[x]) * 255)+(PixelGetBlue(pixels_down[x+1]) * 255))/8);
